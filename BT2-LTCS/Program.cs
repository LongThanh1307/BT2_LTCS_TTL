    ...
    public class Vehicle
    {
        ...
        class Program
        {
            static void Main(string[] args)
            {
                ...
                {
                new Car(1, "Toyota Vios", "Toyota",1989, 500000,5),
                new Car(2, "Honda Accent", "Honda",2000, 200000,5),
                new Car(3, "Toyota Camry", "Toyota",2021, 100000,5),
                new Car(4, "Ford Ranger", "Ford",2020, 700000,4),
            ...
            {
                new Truck(1,"F-150","Ford", 2023, 350000, 8,"Ford Motor Company"),
